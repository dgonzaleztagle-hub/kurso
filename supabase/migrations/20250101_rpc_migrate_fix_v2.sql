-- ==============================================================================
-- INSTALACIÓN DE LÓGICA DE MIGRACIÓN V2 (Corrección de Ambigüedad)
-- ==============================================================================
-- Ejecuta este script en el SQL Editor de Supabase para reparar la función.
-- Hemos renombrado los parámetros (p_*) para evitar confusión con las columnas de la tabla.
...
BEGIN
    ...
    INSERT INTO public.tenants (
        ...
        'active',
        p_new_fiscal_year,
        p_previous_tenant_id, -- Aquí estaba el conflicto, ahora usa p_
        'active', 
